# FROM: https://github.com/nix-community/home-manager/blob/2539eba97a6df237d75617c25cd2dbef92df3d5b/modules/services/restic.nix#L1C1-L601C2
# Changes `PrivateTmp` to false to avoid ~/.ssh/config permission issues
{
  config,
  lib,
  pkgs,
...
let
  ...
  cfg = config.services.restic-kit;
